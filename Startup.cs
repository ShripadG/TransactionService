...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new Info { Title = "Transaction service", Version = "v1" });
        ...
        if (creds.username != null && creds.password != null && creds.host != null)
        {
            ...
            services.AddTransient<IPostTransactionProcessor, PostTransactionProcessor>();
            services.AddTransient<IPutTransactionProcessor, PutTransactionProcessor>();
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "Transaction Web API V1");
